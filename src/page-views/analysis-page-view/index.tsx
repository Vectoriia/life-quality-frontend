...
const data: AnalysisInfoDto = {
    dateTime: dayjs().format(`DD ${convertMonthName(dayjs().format('MMMM'))} YYYY HH:mm`),
...
const AnalysisPageView: React.FC = () => {
    return (
        <div className="absolute flex flex-col top-[110px] mx-[200px] bg-white rounded-lg py-4 px-6">
            <Typography variant="h4" className="mb-2">Тип аналізу: {data.type}</Typography>
            <div className="flex justify-between mb-6">
                <div className="flex flex-col gap-1 [&>*]:flex [&>*]:items-center [&>*]:gap-2 ">
                    ...
                    <Typography>{getStatusIcon(data.status, 24)} Статус: {AnalysisStatus[data.status]}</Typography>
                </div>
                <div className="flex items-end">
                    <Button variant="outlined" className="">Написати рекомендацію</Button>
                </div>
            </div>
            <div className="mb-6">
                <Typography variant="h5" className="mb-2">Детальний опис</Typography>
