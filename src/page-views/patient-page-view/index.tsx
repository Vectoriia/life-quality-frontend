...
import { AnalysisStatus } from "../analysis-view";
...
const PatientPageView: React.FC = () => {
    return (
        <div className="absolute flex flex-col top-[110px] mx-[200px] bg-white rounded-lg py-4 px-6">
            <Typography variant="h4" className="mb-2">{data.name}</Typography>
            <div className="flex justify-between mb-6">
                <div className="flex flex-col gap-1 [&>*]:flex [&>*]:items-center [&>*]:gap-2 ">
                    ...
                    <Typography>{getStatusIcon(data.patientStatus, 24)} Статус: {PatientStatus[data.patientStatus]}</Typography>
                    <Typography>
                        <FiPhoneCall size={24} />
            ...
            <div className="mb-6">
                <Typography variant="h5" className="mb-2">Короткий опис стану пацієнта</Typography>
            ...
            <div>
                <Typography variant="h5">Історія аналізів</Typography>
                    {data.analysis.map((analysis, index) => (
                        <div key={index} className="flex items-center justify-between border-solid border-0 border-b px-6 py-1">
                            <Typography>
                                {index + 1}.
                            </Typography>
                            <Typography>
